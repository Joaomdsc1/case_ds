...
# Criamos o pipeline, mas sem um modelo final ainda
pipeline = Pipeline(steps=[('preprocessor', preprocessor),
                           ('classifier', RandomForestClassifier(random_state=42, class_weight='balanced'))])

# 5. DEFINIÇÃO DO GRID DE HIPERPARÂMETROS
# Aqui definimos os valores que o GridSearchCV vai testar.
param_grid = {
...
# 6. CONFIGURAÇÃO E EXECUÇÃO DO GRIDSEARCHCV
# scoring='f1_weighted' instrui o GridSearch a otimizar pelo F1-Score, uma boa métrica para dados desbalanceados.
...
# 7. ANÁLISE DOS RESULTADOS DO GRIDSEARCH
print("\n--- Resultados do GridSearchCV ---")
print("Melhores parâmetros encontrados:")
print(grid_search.best_params_)

# 8. AVALIAÇÃO DO MELHOR MODELO NO CONJUNTO DE TESTE
print("\n--- Avaliação Final do Melhor Modelo (encontrado pelo GridSearchCV) no Conjunto de Teste ---")
